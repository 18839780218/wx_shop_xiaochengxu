...
Page({
  ...
  formSubmit: function (e) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.redirectTo({
            url: 'user-address/user-address?cartId=' + cartId + '&&cgid=' + cgids
          });
      },
      fail: function () {
        // fail
  ...
  bindPickerChangeshengArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: con.Index_getCitybyProvinceCode,
      data: { wxappid: con.wyy_user_wxappid, ProvinceCode: that.data.provinceCode },
      method: 'POST', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
      header: {// 设置请求的 header
        'Content-Type': 'application/x-www-form-urlencoded'
      },
  ...
  bindPickerChangeshiArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: con.Index_getAreabyCityCode,
      data: {
        wxappid: con.wyy_user_wxappid,
